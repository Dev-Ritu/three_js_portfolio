      ...
      <div className="grid xl:grid-cols-3 grid-cols-1 gap-5 h-full">
        ...
        <div
          ...
          <div className="flex-shrink-0">
            <img src="assets/Ritu_SoftwareDeveloper.png" alt="grid-1" className="w-[150px] h-[150px] object-cover rounded-md" />
          </div>
          ...
          <div>
            ...
            <p className="grid-subtext text-gray-700">
              With more than 3 years of experience, I have honed my skills in frontend and backend development, creating
        ...
        {/* TechStack Section */}
        <div className="col-span-3 xl:row-span-1" ref={techRef}>
          <TechCard techStackSections={techStackSections} />
        </div>

        {/* Remaining Sections in a Single Row */}
        <div
          className="col-span-3 xl:col-span-1 xl:row-span-2"
          ref={globeRef}
